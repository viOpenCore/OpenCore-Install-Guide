...
* iMacPro1,1 và MacPro7,1 đều chỉ là 2 SMBIOS mà sẽ cho phép dGPU gánh tất cả các lượng công việc bao gồm xử lý nền và những cái khác mà iGPU sẽ gánh
  * Chúng tôi chỉ khuyến khích những SMBIOS này nếu bạn cần phải có nó, tuy nhiên bạn có thể sẽ cần phải sửa phần quản lý điện năng vì có thể làm hỏng chế độ ngủ nếu phần cứng của của bạn không thuộc các loại này(VD. HEDT/Server/AMD): [Fixing Power management](https://viopencore.github.io/OpenCore-Post-Install/universal/pm.html)
